...
def inference(input, num_output, training):
    ...
    fc3 = tf.layers.dense(fc2, num_fc2,
                          bias_initializer=tf.constant_initializer(0.1),
                          activation='relu', kernel_regularizer=regularizer)
    logit = tf.layers.dense(fc1, num_output)
    return logit
